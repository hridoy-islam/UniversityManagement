...
function CourseUnitPage() {
  ...
  const fetchData = async (
    ...
    try {
      ...
      // Fetch course name
      const courseRes = await axiosInstance.get(`/course/${courseId}`);
    ...
    <div className="">
      ...
      <Card className="">
        ...
        <CardHeader className="flex flex-row items-center justify-between pb-6">
          <div>
            <CardTitle className="text-2xl font-bold"> {courseName} Modules</CardTitle>
          ...
          <Dialog open={dialogOpen} onOpenChange={setDialogOpen}>
            ...
            <DialogContent className="sm:max-w-md">
              <DialogHeader>
                <DialogTitle>
                  {isEditing ? 'Edit Course Module' : 'Add New Course Module'}
                </DialogTitle>
              </DialogHeader>
              <div className="space-y-4 py-4">
                <div className="grid grid-cols-1 gap-4">
                  <div className="space-y-2">
                    <Label htmlFor="unitRef">Module Reference</Label>
                    <Input
                      id="unitRef"
                      value={unitReference}
            ...
            <>
              <div className="overflow-x-auto">
                <Table>
                  <TableHeader>
                    <TableRow>
                      <TableHead>Module Reference</TableHead>
