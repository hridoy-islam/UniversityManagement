                  ...
                  <TableCell className="text-right">
                    <DropdownMenu>
                      ...
                      <DropdownMenuContent className="bg-white text-black border-gray-200 ">
                        <DropdownMenuItem className="hover:bg-theme "  onClick={() => navigate("log-manager")}>Log Manager</DropdownMenuItem>
                        <DropdownMenuItem className="hover:bg-theme ">View Details</DropdownMenuItem>
