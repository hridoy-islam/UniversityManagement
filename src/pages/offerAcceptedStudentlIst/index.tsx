...
export default function OfferAcceptedPage() {
  ...
  const fetchData = async (
    ...
    try {
      ...
      const res = await axiosInstance.get('/application-course?offerType=conditional&offerType=unconditional', { params });
      ...
      <div className="flex-1 space-y-6">
        ...
        <Card>
          <CardContent className="space-y-4 pt-4">
            <div>
          <CardTitle className="text-2xl font-bold">Offer Accepted Student List</CardTitle>
        </div>
            {/* Search & Filter Grid */}
