...
export default function EditAgentPage() {
  ...
  useEffect(() => {
    // Load existing staff by ID (mock)
      ...
      <Card>
        <CardHeader>
          <div className="flex items-center gap-4">
            ...
            <div>
              <CardTitle className="text-2xl font-bold">Edit Agent</CardTitle>
              <CardDescription className="mt-1 text-xs">
                Update agent details, address, and assigned campuses
              </CardDescription>
            </div>
          </div>
        </CardHeader>
